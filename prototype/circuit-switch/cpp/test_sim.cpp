...
#include "CircuitSwTopSimIndication.h"
#include "CircuitSwTopSimRequest.h"
#include "GeneratedTypes.h"

static CircuitSwTopSimRequestProxy *device = 0;

class CircuitSwTopSimIndication : public CircuitSwTopSimIndicationWrapper
{
public:
    ...
    CircuitSwTopSimIndication(unsigned int id) :
        CircuitSwTopSimIndicationWrapper(id) {}
};


int main(int argc, char **argv)
{
    CircuitSwTopSimIndication echoIndication(IfcNames_CircuitSwTopSimIndicationH2S);
    device = new CircuitSwTopSimRequestProxy(IfcNames_CircuitSwTopSimRequestS2H);
